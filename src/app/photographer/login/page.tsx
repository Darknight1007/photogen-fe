  ...
  return (
    <>
      ...
      <nav className="phl-nav">
        ...
        <Link href="/user/login" style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--muted)", textDecoration: "none", transition: "color 0.2s" }}>
          Find photos? →
        </Link>
      </nav>
      ...
      <main style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "100vh", paddingTop: 68, boxSizing: "border-box" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "60px 80px", borderRight: "1px solid var(--border)", position: "relative", overflow: "hidden", background: "radial-gradient(ellipse at 70% 50%, rgba(212,175,55,0.08) 0%, transparent 60%)" }}>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            <div style={{ fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--gold3)", background: "rgba(212,175,55,0.06)", border: "1px solid rgba(212,175,55,0.15)", borderRadius: 20, padding: "5px 14px", marginBottom: 24, width: "fit-content" }}>Studio</div>
            <h1 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(36px, 4vw, 52px)", fontWeight: 300, fontStyle: "italic", lineHeight: 1.1, color: "var(--cream)", marginBottom: 16 }}>
              Photographer<br />
              <span style={{ fontStyle: "normal", fontWeight: 600, color: "var(--gold)" }}>Studio.</span>
            </h1>
